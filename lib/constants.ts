...
export const RECORDING_PROMPTS = [
  {
    id: 1,
    title: 'Warm-Up',
    description: 'Say: "Hello, this is my voice" and introduce yourself briefly',
    duration: '15 seconds',
  ...
  },
  {
    ...
    description: 'Briefly tell us about your favorite childhood memory',
    duration: '15 seconds',
  ...
  },
  {
    ...
    description: 'Briefly describe someone you love and why they\'re special',
    duration: '15 seconds',
  ...
  },
  {
    ...
    description: 'Read this passage aloud naturally for about 15 seconds',
    duration: '15 seconds',
  ...
  },
  {
    ...
    description: 'Briefly tell us about your proudest accomplishment',
    duration: '15 seconds',
  ...
  },
  {
    ...
    description: 'Say these phrases naturally with emotion (repeat a few times)',
    duration: '15 seconds',
